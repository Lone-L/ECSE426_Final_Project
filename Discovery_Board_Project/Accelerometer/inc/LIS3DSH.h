...
/**
  ...
  * @{
  */
 #define LIS3DSH_SENSITIVITY_2G    	((float)0.061)
 #define LIS3DSH_SENSITIVITY_4G		 ((float)0.122)
 #define LIS3DSH_SENSITIVITY_6G			((float)0.183)
 #define LIS3DSH_SENSITIVITY_8G		  ((float)0.244)
 #define LIS3DSH_SENSITIVITY_16G    ((float)0.488)
  /**
  * @}
  */
